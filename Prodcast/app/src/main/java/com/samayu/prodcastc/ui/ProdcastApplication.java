...
/**
 * Created by kdsdh on 9/9/2017.
 */

public class ProdcastApplication extends Application {
    @Override
    ...
    public static void overrideFont(Context context, String defaultFontNameToOverride, String customFontFileNameInAssets) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {
                ...
                Log.e(ProdcastApplication.class.getSimpleName(), "Can not set custom font " + customFontFileNameInAssets + " instead of " + defaultFontNameToOverride);
            }
        }
    }
}
